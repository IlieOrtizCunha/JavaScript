...
// Testando a função com um id existente
const livroExistente = encontrarLivroPorId(1);
if (livroExistente) {
    console.log("Livro encontrado:", livroExistente);
} else {
    console.log("Livro com id 1 não foi encontrado.");
}

// Testando a função com um id inexistente
const livroInexistente = encontrarLivroPorId(5);
if (livroInexistente) {
    console.log("Livro encontrado:", livroInexistente);
} else {
    console.log("Livro com id 5 não foi encontrado.");
}
...
function filtrarOrdenarProdutosPorPreco(maxPreco){
    const produtos = listaProdutos.filter((produto) => produto.preco <= maxPreco )
    return produtos.sort((a, b) => a.preco - b.preco);
}

console.log(filtrarOrdenarProdutosPorPreco(400.00));
...
// Array de objetos representando informações de animais
const animais = [
...
// Função para ordenar o array de animais com base em uma função de comparação
function ordenarAnimais(comparador) {
    return animais.sort(comparador);
}

// Função de comparação para ordenação crescente por idade
function compararPorIdadeCrescente(a, b) {
    return a.idade - b.idade;
}

// Função de comparação para ordenação decrescente por idade
function compararPorIdadeDecrescente(a, b) {
    return b.idade - a.idade;
}

// Ordenação crescente por idade
console.log("Ordenação Crescente por Idade:");
console.log(ordenarAnimais(compararPorIdadeCrescente));

// Ordenação decrescente por idade
console.log("Ordenação Decrescente por Idade:");
console.log(ordenarAnimais(compararPorIdadeDecrescente));
...
if (funcionarioExistente) {
    ...
    console.log("Funcionário com id 3 não foi encontrado.");
}

// Testando a função com um id inexistente
const funcionarioInexistente = encontrarFuncionarioPorId(10);
if (funcionarioInexistente) {
    console.log("Funcionário encontrado:", funcionarioInexistente);
} else {
    console.log("Funcionário com id 10 não foi encontrado.");
}